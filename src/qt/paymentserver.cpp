...
const QString BITCOIN_IPC_PREFIX("rvdcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click rvdcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start rvdcoin: click-to-pay handler");
    else
...
{
    // clicking on rvdcoin: URLs creates FileOpen events on the Mac:
