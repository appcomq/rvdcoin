...
uint256 hashGenesisBlock("0x000000d03ff2f1c9087f0c6e2d852871cb846f758d6de79af697271fe4abc676");
static const unsigned int timeGenesisBlock = 1385942400;//Human time (GMT): Mon, 02 Dec 2013 00:00:00 GMT
...
const string strMessageMagic = "Rvdcoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "02 Dec 2013, Rvdcoin is comming!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
/*
        ...
        //printf("hash.ToString().c_str() is %s\n", hash.ToString().c_str());
        //printf("hashGenesisBlock.ToString().c_str() is %s\n", hashGenesisBlock.ToString().c_str());
        //printf("block.hashMerkleRoot.ToString().c_str() is %s\n", block.hashMerkleRoot.ToString().c_str());
        ...
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        block.print();
        assert(block.hashMerkleRoot == uint256("0x99a2c68231e09ef28278152988fe582a4d9d94f1db3290f65fbc6f35563dc2e5"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RvdcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RvdcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("RvdcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("rvdcoin-miner");
    ...
    try { loop {
        ...
        printf("Running RvdcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("RvdcoinMiner terminated\n");
        throw;
    }
}
